...
API_ID = int(os.environ.get("API_ID", "29899250"))
API_HASH = os.environ.get("API_HASH", "611d045796c79af3e5ddfa3d6fd536a7")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8302192118:AAF7HCdZ6qfQAUg1-v86WezbXhcfBrI1ZVM")
